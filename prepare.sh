...
${VM_RAM:=1024}
${VM_VCPU:=1}
${VM_IPADDR:=10.0.0.149}

${VM_SWAP_SIZE:=512}
${VM_VOLUME_SRC_PATH:=/data/volumes/cloud/CentOS-8-GenericCloud-8.2.2004-20200611.2.x86_64.qcow2}
${VM_VOLUME_SRC_PART:=/dev/sda1}
${VM_VOLUME_PATH:=/var/lib/libvirt/images/centos-8.qcow2}
${VM_VOLUME_SIZE:=64G}
